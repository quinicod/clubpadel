...
<body>
    ...
    <div id="overbox3">
        <div id="infobox3">
            <p>Esta web tiene @copyright de Joaquín Guzmán García-Plata, Daniel Ortega Ortega y Juanma Rodriguez Rodriguez.
                <a href="politica-privacidad.php">Más información</a>
                <button onclick="aceptar_cookies();" style="cursor:pointer;">Aceptar</button>
            </p>
        </div>
    </div>
    -->
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="{{request()->is('contacta') ? 'active' : ''}} negrita"><a href="#contacta">Contacta</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            <li class="{{request()->is('login') ? 'active' : ''}} negrita"><a href="#" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
...
<nav class="navbar navbar-default col-md-3 pull-left lateral" role="navigation">
  <!-- Brand and toggle get grouped for better mobile display -->
  <div class="navbar-header diferencia">
    ...
    <a class="navbar-brand titulo" href="#">Panel de Usuario</a><br>
  </div>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
        <li>
            <a href="{{ route('panelUsuario') }}">Perfil</a>
    ...
    <div class="container-fluid text-center fondopanel">
        @yield('content')
    </div>
    ...
    <div class="row container-fluid pie">
        ...
        <div class="col-md-3">
            <h4 class="
            ">SUSCRIBETE</h4><br>
            <p>Recive información de nuestros torneos y ofertas.</p><br>
